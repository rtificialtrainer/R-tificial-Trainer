...
public class TimePicker extends FrameLayout{
    ...
    private int mCurrentCSeconds = 0; // 0-99
    ...
    private final NumberPicker mCSecondPicker;
    ...
    public interface OnTimeChangedListener {
         ...
         * @param cseconds The current centisecond.
         */
        void onTimeChanged(TimePicker view, int hourOfDay, int minute, int seconds, int cseconds);
    }
    ...
    public TimePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        // digits of centiseconds
        mCSecondPicker = (NumberPicker) findViewById(R.id.cseconds);
        mCSecondPicker.setMinValue(0);
        mCSecondPicker.setMaxValue(99);
        mCSecondPicker.setFormatter(TWO_DIGIT_FORMATTER);
        mCSecondPicker.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() {

            @Override
            public void onValueChange(NumberPicker picker, int oldVal, int newVal) {
                mCurrentCSeconds = newVal;
                onTimeChanged();
        ...
        setCurrentCSecond(cal.get(Calendar.MILLISECOND));
    ...
    /**
     * @return The current centysecond.
     */
    public Integer getCurrentCSeconds() {
        return mCurrentCSeconds;
    }

    /**
     * Set the current centysecond (0-99).
     */
    public void setCurrentCSecond(Integer currentCSecond) {
        this.mCurrentCSeconds = currentCSecond/10;
        updateCSecondsDisplay();
    }
    ...
    private void onTimeChanged() {
        mOnTimeChangedListener.onTimeChanged(this, getCurrentHour(), getCurrentMinute(), getCurrentSeconds(),getCurrentCSeconds());
    }
    ...
    /**
     * Set the state of the spinners appropriate to the current centisecond.
     */
    private void updateCSecondsDisplay() {
        mCSecondPicker.setValue(mCurrentCSeconds);
        mOnTimeChangedListener.onTimeChanged(this, getCurrentHour(), getCurrentMinute(), getCurrentSeconds(),getCurrentCSeconds());
    }
}
